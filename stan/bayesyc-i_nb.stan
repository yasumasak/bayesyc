...
data{
  ...
  array[Nl] int<lower=0> lc; // Low control target cell count
...
generated quantities{
  ...
  for (n in 1:Nc_new) {
    uc_pred[n] = musyc(dc1_new[n], dc2_new[n], E0, E1, E2, E3, C1, C2, h1, h2, alpha12, alpha21, gamma12, gamma21, r1r, r2r) + noise;
