...
model{
  ...
  C1 ~ gamma(C1_alpha, C1_beta);
  C2 ~ gamma(C2_alpha, C2_beta);
  h1 ~ gamma(h1_alpha, h1_beta);
  h2 ~ gamma(h2_alpha, h2_beta);
  E0 ~ gamma(E0_alpha, E0_beta);
  e1 ~ beta(e1_alpha, e1_beta);
  e2 ~ beta(e2_alpha, e2_beta);
  e3 ~ beta(1, 1);
