...
model{
  ...
  C1 ~ gamma(C1_alpha / 5, C1_beta / 5);
  C2 ~ gamma(C2_alpha / 5, C2_beta / 5);
  h1 ~ gamma(h1_alpha / 5, h1_beta / 5);
  h2 ~ gamma(h2_alpha / 5, h2_beta / 5);
  E0 ~ gamma(E0_alpha / 5, E0_beta / 5);
  e1 ~ beta(ext_beta_param(e1_alpha, e1_beta, 5)[1], ext_beta_param(e1_alpha, e1_beta, 5)[2]);
  e2 ~ beta(ext_beta_param(e2_alpha, e2_beta, 5)[1], ext_beta_param(e2_alpha, e2_beta, 5)[2]);
  e3 ~ beta(1, 1);
